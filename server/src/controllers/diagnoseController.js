...
async function generateContentWithModelFallback(geminiClient, payload, prompt) {
  ...
  const error = new Error(
    lastError?.message || "All Gemini model attempts failed.",
  );
...
const commonDiseases = [
  // Tomato
  {
    ...
    season: "Kharif",
    symptom:
      "Brown/dark spots on leaves with white mold on underside; spreads rapidly in humid weather.",
  },
  {
    name: "Early Blight",
    crop: "Tomato",
    ...
    season: "Kharif",
    symptom:
      "Dark concentric rings (target spots) on older leaves; yellowing around lesions.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Small, circular spots with dark borders and grey centres on lower leaves.",
  },
  {
    ...
    season: "Rabi",
    symptom:
      "Mottled yellow-green leaves, leaf curling, stunted growth; spread by aphids.",
  },
  {
    name: "Fusarium Wilt",
    crop: "Tomato",
    ...
    season: "Summer",
    symptom:
      "Yellowing of lower leaves, wilting despite adequate water; brown vascular tissue.",
  },
  // Wheat
  {
    name: "Powdery Mildew",
    ...
    season: "Rabi",
    symptom:
      "White powdery coating on leaves and stems; reduces photosynthesis significantly.",
  },
  {
    name: "Yellow Rust",
    crop: "Wheat",
    ...
    season: "Rabi",
    symptom:
      "Yellow-orange stripe pustules along leaf veins; severe yield loss if untreated.",
  },
  {
    name: "Brown Rust",
    crop: "Wheat",
    severity: "Medium",
    season: "Rabi",
    symptom: "Oval orange-brown pustules scattered on leaf surface.",
  },
  {
    name: "Karnal Bunt",
    crop: "Wheat",
    ...
    season: "Rabi",
    symptom:
      "Partial replacement of grain kernels with black smelly powder; fishy odour.",
  },
  {
    name: "Loose Smut",
    crop: "Wheat",
    ...
    season: "Rabi",
    symptom:
      "Ears replaced by black masses of smut spores; completely destroys the head.",
  },
  // Rice
  {
    name: "Rice Blast",
    ...
    season: "Kharif",
    symptom:
      "Diamond-shaped lesions on leaves; can kill entire tillers (neck rot).",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Water-soaked to yellow-white lesions along leaf margins from tips.",
  },
  {
    name: "Sheath Blight",
    crop: "Rice",
    ...
    season: "Kharif",
    symptom:
      "Oval or irregular greyish lesions on leaf sheaths near waterline.",
  },
  {
    name: "Brown Spot",
    crop: "Rice",
    ...
    season: "Kharif",
    symptom:
      "Oval brown spots with yellow halo on leaves; linked to nutrient deficiency.",
  },
  // Cotton
  {
    name: "Root Rot",
    ...
    season: "Kharif",
    symptom:
      "Wilting despite adequate water; dark discolouration of root tissue.",
  },
  {
    name: "Bollworm",
    crop: "Cotton",
    severity: "High",
    season: "Kharif",
    symptom: "Larvae bore into bolls; frass visible; premature boll opening.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Upward curling of leaves, dark-green enations on underside; whitefly-transmitted.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Dark brown spots with concentric rings on leaves; premature defoliation.",
  },
  // Mustard
  {
    ...
    season: "Rabi",
    symptom:
      "Dense colonies of small green/black insects on growing tips and underside of leaves.",
  },
  {
    name: "White Rust",
    crop: "Mustard",
    ...
    season: "Rabi",
    symptom:
      "White chalky pustules on underside of leaves; distortion of flowering parts.",
  },
  {
    ...
    season: "Rabi",
    symptom:
      "Dark brown circular spots with concentric rings; premature leaf drop.",
  },
  // Maize
  {
    name: "Fall Armyworm",
    ...
    season: "Kharif",
    symptom:
      "Ragged feeding on young leaves; caterpillars in whorls with frass; windowpane feeding.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Long, cigar-shaped grey-green lesions on leaves; starts from lower leaves.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Yellow streaks along veins; stunted plants; spread by leafhoppers.",
  },
  // Sugarcane
  {
    name: "Red Rot",
    ...
    season: "Kharif",
    symptom:
      "Red discolouration inside the stalk with white patches; sour smell.",
  },
  {
    name: "Smut",
    crop: "Sugarcane",
    severity: "High",
    season: "Kharif",
    symptom: "Long black whip-like structure emerging from growing point.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Stunted ratoon growth; orange/yellow discolouration of vascular bundles.",
  },
  // Potato
  {
    name: "Late Blight",
    ...
    season: "Rabi",
    symptom:
      "Water-soaked dark lesions on leaves and tubers; white sporulation in humid conditions.",
  },
  {
    name: "Common Scab",
    crop: "Potato",
    ...
    season: "Rabi",
    symptom:
      "Rough, corky lesions on tuber surface; mainly cosmetic but reduces marketability.",
  },
  {
    name: "Black Leg",
    crop: "Potato",
    ...
    season: "Rabi",
    symptom:
      "Black rot at stem base; plants wilt and collapse; bacteria-spread in wet soils.",
  },
  // Onion
  {
    name: "Purple Blotch",
    ...
    season: "Rabi",
    symptom:
      "Purple lesions with yellow margins on leaves; severe in humid weather.",
  },
  {
    name: "Basal Rot",
    crop: "Onion",
    ...
    season: "Rabi",
    symptom:
      "Bulb decays from base; pink/white fungal growth; post-harvest losses.",
  },
  // Groundnut
  {
    ...
    season: "Kharif",
    symptom:
      "Circular dark spots with yellow halo on upper surface; reduces photosynthesis.",
  },
  {
    name: "Late Leaf Spot",
    crop: "Groundnut",
    ...
    season: "Kharif",
    symptom:
      "Dark spots with no yellow halo; predominantly on underside of leaves.",
  },
  {
    name: "Stem Rot",
    crop: "Groundnut",
    ...
    season: "Kharif",
    symptom:
      "White cottony mycelium at stem base; plants wilt and die; black sclerotia visible.",
  },
  // Soybean
  {
    ...
    season: "Kharif",
    symptom:
      "Mottling, puckering and distortion of leaves; stunted plants; seed transmitted.",
  },
  {
    name: "Pod Borer",
    crop: "Soybean",
    severity: "High",
    season: "Kharif",
    symptom: "Larvae bore into pods; damaged seeds; webbing and frass on pods.",
  },
  // Chilli
  {
    name: "Anthracnose",
    ...
    season: "Kharif",
    symptom:
      "Sunken dark lesions on fruits; in concentric rings; postharvest losses.",
  },
  {
    ...
    season: "Kharif",
    symptom:
      "Severe curling, puckering and stunting of leaves; whitefly-transmitted.",
  },
  // Mango
  {
    name: "Powdery Mildew",
    ...
    season: "Rabi",
    symptom:
      "White powdery growth on inflorescence and young fruit; severe flower and fruit drop.",
  },
  {
    name: "Anthracnose",
    crop: "Mango",
    severity: "Medium",
    season: "Kharif",
    symptom: "Black lesions on leaves and fruits; postharvest rot in transit.",
  },
];
...
export async function getDiseaseCatalog(req, res) {
  ...
  if (cropFilter) {
    filtered = filtered.filter((item) =>
      item.crop.toLowerCase().includes(cropFilter),
    );
  }
  if (severityFilter) {
  ...
  try {
    ...
    if (!parsedPayload.success) {
      return res.status(400).json({
        message:
          parsedPayload.error.issues[0]?.message || "Invalid image payload",
      });
    }
